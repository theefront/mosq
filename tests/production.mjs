...
try{
 ...
 await page.goto(`${siteUrl}?demo=1&quality=medium`,{waitUntil:'networkidle'});await expect(page.locator('.loading-label')).toHaveCount(0);await expect(page.locator('canvas')).toBeVisible();
